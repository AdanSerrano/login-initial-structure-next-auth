...
import { useWatch, type Control, type FieldValues, type FieldPath, type PathValue } from "react-hook-form";
...
export interface FieldCondition<TFieldValues extends FieldValues = FieldValues> {
  field: FieldPath<TFieldValues>;
  operator: ConditionOperator;
  value?: PathValue<TFieldValues, FieldPath<TFieldValues>> | PathValue<TFieldValues, FieldPath<TFieldValues>>[];
}

export interface FormConditionalFieldProps<TFieldValues extends FieldValues = FieldValues> {
...
function FormConditionalFieldComponent<TFieldValues extends FieldValues = FieldValues>({
  control,
  conditions,
  logic = "and",
  children,
